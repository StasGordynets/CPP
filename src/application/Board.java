...
public class Board extends Group {
  ...
  public static String Files[] = new String[100000];
  public static int FilesData[] = new int[100000];
  public static int avrStep[] = new int[100000];
  public static int avrScore[] = new int[100000];
  public static long avrTime[] = new long[100000];
  //public static long timeBig[] = new long[100000];
  ...
  public boolean restoreSession(Map<Location, Tile> gameGrid) {
    ...
    int score = sessionManager.openLastStepOfSession(gameGrid, sTime);
    if (score >= 0) {
  ...
  public static boolean sessionStatistic(File gameReadALLFile) {
    
    String time = SessionManager.sortingFileTime(gameReadALLFile);
    int numberOfSave = SessionManager.SortingFileStep(gameReadALLFile);
    int score = SessionManager.SortingFileScore(gameReadALLFile);

    avrStep[count] = numberOfSave;
    
    avrScore[count] = score;
